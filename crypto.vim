...
set path=.,,**
set ruler
set runtimepath=~/.vim,~/.vim/plugged/rust.vim/,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vim80/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/plugged/rust.vim/after,~/.vim/after
set shiftwidth=4
set tabstop=4
set viminfo='20,\"50
...
silent only
cd ~/Development/Rust/crypto/crypto_pals
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +32 src/encoded_string.rs
badd +33 src/main.rs
badd +4 ~/.vimrc
argglobal
silent! argdel *
